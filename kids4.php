                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/kids4.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/kids4-2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/kids4-3.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Polo Kids Clothes</h4>
                        <span class="price">PHP 638.98</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            Baby Boys Shirts Polo Kids Clothes Long Sleeve Bottoming Shirt Cotton Tops Children's
                            Costume 2022 Spring Autumn Outwear
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Polo Kids Clothes"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="638.98"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                <label class="form-label" for="" style="float:left;">Status</label>
                                <input type="hidden" id="" class="form-control" name="url" value="kids4.php" readonly />
                            </div>

                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/women3.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women3-2.png" alt="" style="width:320px; height:320px;" />
                            <!-- <img src="assets/images/women3-3.png" alt="" style="width:320px; height:320px;" /> -->
                            <img src="assets/images/women3-4.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/ribbon-girl2.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Ribbon Butterfly</h4>
                        <span class="price">PHP 17.35</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            Women Vintage Satin Bow Hairpins Solid Color Bowknot Hair Clips Ribbon Butterfly Barrettes
                            Bangs Ponytail Girls Headwear
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">Red
                        </button>
                        <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">Purple
                        </button>
                        <!-- <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">White
                        </button> -->
                        <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">Green
                        </button>
                        <br>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Ribbon Butterfly"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="17.35" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="women3.php"
                                    readonly />
                            </div>

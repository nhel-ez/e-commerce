                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/kids2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/kids2-2.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Bowknot Ribbon</h4>
                        <span class="price">PHP 94.00</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            Kids Fashion Satin Hairpin Sweet Bowknot Ribbon Hairclip Solid Double Bow Duckbill Clip
                            Women Hair Accessories for Girls
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">Pink
                        </button>
                        <br>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Bowknot Ribbon"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="94.00" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="kids2.php" readonly />
                            </div>

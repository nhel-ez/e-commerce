...
<body>
    ...
    <center>
        <div class="container" style="margin-top:150px; max-width:70%">
            <h3 style="margin-bottom:30px;">Are you sure you want to buy again this item?</h3>
            <form action="update-buy-again.php?id=<?php echo $id; ?>" method="post">

                <div class="form-outline mb-4 col-md-8">
                    <label class="form-label" for="" style="float:left;" hidden>Status</label>
                    <input type="hidden" id="" class="form-control" name="status" value="Checkout" readonly />
                </div>

                <div class="text-center pt-1 mb-5 pb-1 col-md-4">
                    <button class="btn btn-dark" type="submit" name="submit">Buy Again</button>
                </div>
            </form>
        </div>
    </center>

                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/women1.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women1-2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women1-3.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women1-4.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Summer Dress</h4>
                        <span class="price">PHP 740.82</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            New Arrival Fashion 2022 Summer Dress For Women Slim Loose V-Neck Casual Women Clothing
                            Print Dresses
                        </span>
                        <hr>
                        <br>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Summer Dress" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="740.824"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="women1.php"
                                    readonly />
                            </div>

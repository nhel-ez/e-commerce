                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/image6.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/image6-1.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/image6-2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/image6-3.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Summer Polo</h4>
                        <span class="price">PHP 718.74</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>2022 Summer Mens Polo Shirt Short Sleeve Polo Business T Shirt Print Slim Fit New Clothing
                            Streetwear Casual Fashion Men Tops
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">Blue
                        </button>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Summer Polo" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="718.74"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="men1.php" readonly />
                            </div>

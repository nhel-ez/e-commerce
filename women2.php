                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/women2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women2-2.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Leisure Dress</h4>
                        <span class="price">PHP 3,021.46</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            Black Leisure Dress For Women Four Seasons Retro Square Collar Puff Sleeve Long Woman
                            Dresses French Small Crowd Waist Show Thin
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Leisure Dress" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="3021.46"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="women2.php"
                                    readonly />
                            </div>

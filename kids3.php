                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/kids3.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/kids3-2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/kids3-3.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Summer Calf</h4>
                        <span class="price">PHP 558.97</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            EACHIN Baby Boys Shorts Casual Solid Colors Elastic Waist Boy Pants Summer Calf Length Kids
                            Trousers Soft Pants Children Clothes
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <button class="btn btn-outline-dark pick1" onclick="setInputVariation(this.innerHTML)">Khaki
                        </button>
                        ...
                        <h6>Size</h6>
                        <br>
                        <button class="btn btn-outline-dark pick2" onclick="setInputSize(this.innerHTML)">XS
                        </button>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Summer Calf" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="558.97"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="kids3.php" readonly />
                            </div>

...
<body>
    ...
    <center>
        <div class="container" style="margin-top:150px; max-width:70%">
            <h3 style="margin-bottom:30px;">Rate this item.</h3>
            <form action="update-rate.php?id=<?php echo $id; ?>" method="post">

                <div class="form-outline mb-4 col-md-8" hidden>
                    <label class="form-label" for="" style="float:left;">Status</label>
                    <input type="number" id="" class="form-control" name="rate" value="<?php echo $row['rate']; ?>"
                        readonly />
                </div>

                <div class="text-center pt-1 mb-5 pb-1 col-md-4">
                    <button class="btn btn-dark" type="submit" name="submit">Rate Star</button>
                </div>
            </form>
        </div>
    </center>

...
<body>
    ...
    <center>
        <div class="container" style="margin-top:150px; max-width:70%">
            <h3 style="margin-bottom:30px; color:red;">Are you sure you want to cancel this item?</h3>
            <form action="update-cancel.php?id=<?php echo $id; ?>" method="post">

                <div class="form-outline mb-4 col-md-8">
                    <label class="form-label" for="" style="float:left;" hidden>Status</label>
                    <input type="hidden" id="" class="form-control" name="status" value="Canceled" readonly />
                </div>

                <div class="text-center pt-1 mb-5 pb-1 col-md-4">
                    <button class="btn btn-danger mb-3" type="submit" name="submit">Cancel
                        Order</button>
                </div>
            </form>
        </div>

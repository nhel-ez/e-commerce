                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/image8.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/image8-1.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/image8-2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/image8-3.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Men's Jogger</h4>
                        <span class="price">PHP 988.75</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            Mens Joggers Pants Summer Fashion Sweatpants Fitness Tracksuit Jogging Pants Men Gym
                            Sports Trousers Harajuku Hip Hop Streetwear
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Men's Jogger" readonly
                                    required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="988.75"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="men3.php" readonly />
                            </div>

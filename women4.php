                ...
                <div class="col-lg-8">
                    <center>
                        <div class="left-images">
                            <img src="assets/images/women4.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women4-2.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women4-3.png" alt="" style="width:320px; height:320px;" />
                            <img src="assets/images/women4-4.png" alt="" style="width:320px; height:320px;" />
                        </div>
                    </center>
                </div>
                <div class="col-lg-4">
                    <div class="right-content">
                        <h4>Chiffon Blouse</h4>
                        <span class="price">PHP 734.66</span>
                        <ul class="stars">
                            <?php
                        ...
                        <span>
                            Chiffon Blouse New Women Tops Long Sleeve Stand Neck Work Wear Shirts Elegant Lady Casual
                            Blouses women's blusas clothe
                        </span>
                        <hr>
                        <br>
                        <h6>Variation</h6>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-outline mb-2" hidden>
                                <label class="form-label" for="" style="float:left;">Item
                                    Name</label>
                                <input type="text" id="" class="form-control" name="item" value="Chiffon Blouse"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-2" hidden>
                                ...
                                <input type="number" id="price" class="form-control" name="price" value="734.66"
                                    readonly required />
                            </div>
                            ...
                            <div class="form-outline mb-4" hidden>
                                ...
                                <input type="hidden" id="" class="form-control" name="url" value="women4.php"
                                    readonly />
                            </div>
